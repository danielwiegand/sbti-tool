                 ...
                 tabPanel("Quick guide",
                          ...
                          fluidRow(
                            ...
                            column(6,
                                   ...
                                   HTML("<ol><li>Select a target-setting method in section 1 of the SBT or scope 3 tool sheets<br />
                     ...
                     <li>Enter emissions and activity data in section 1, as required by the method selected</li>
                     <li>Review the summary of results available from the selected SBT method</li>
                     <li>You can review the full data set of target modelling results in section 4</li></ol>
                     "),
